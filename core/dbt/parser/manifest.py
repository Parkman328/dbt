...
@dataclass
class ManifestPerformanceInfo(JsonSchemaMixin, Writable):
    is_partial_parse_enabled: bool
    path_count: int = 0
    parse_project_elapsed: str = '0'
    projects: List[Dict] = field(default_factory=list)
    patch_sources_elapsed: str = '0'
    process_manifest_elapsed: str = '0'
    load_all_elapsed: str = '0'
...
class ManifestLoader:
    def __init__(
        ...
        self._perf_info: ManifestPerformanceInfo = \
            ManifestPerformanceInfo(is_partial_parse_enabled=partial_parse)
    ...
    def parse_project(
        ...
        project_info['time'] = '{:.2f}'.format(elapsed)
